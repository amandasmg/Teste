...
<!-- Inserido pela UFBA -->
<script>
        var elems = document.getElementsByClassName("category"); for (var i = 0; i < elems.length; i++) { elems[i].className += " collapsed" }

        var getElementByXpath = function (path) {
                return document.evaluate(path, document, null, 9, null).singleNodeValue;
        };
        getElementByXpath('//*[@id="frontpage-category-combo"]/div/div[1]/a').click()
</script>
